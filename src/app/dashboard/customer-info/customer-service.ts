...
export class CustomerService {
    ...
    updateCustomerInput(str1, data) {

        return this.http.post("https://spoonkart-service.herokuapp.com/update/" + str1, data, options).map(res => res.json()).subscribe(data => console.log(data));
